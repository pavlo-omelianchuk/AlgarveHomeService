...
const SignupForm = () => {
  ...
  const treatments = [
    ...
    'Galvanophoresis, Ionophoresis – Hydration',
    'Ultrasonic radar hifu',
    'Needles-free mesotherapy (ionophoresis)',
    'Face microcurrent',
    'Pressotherapy',
    'Darsonval for face',
    'Darsonval for hair',
    'Anticouperosis program',
    'Rejuvenation program 40+ 50+',
    'Magiray beauty peel puree',
    'WAXING: Face',
    'WAXING: Fluff',
    'WAXING: Underarms',
    'WAXING: Normal groin / belly',
    'WAXING: Total groin',
    'WAXING: Half leg',
    'WAXING: Full leg',
    'WAXING: Half arm',
